...
class Advent21Spec extends AnyFreeSpec {
  ...
  "part 2 simulation" - {
    ...
    "test 100" in {
      part2Simulation(testData, 100) shouldEqual 6536
    }

    "test 500" in {
      part2Simulation(testData, 500) shouldEqual 167004
    }

    // This is not supposed to be fast
    "test 1000" ignore {
      part2Simulation(testData, 1000) shouldEqual 668697
    }

    // This is not supposed to be fast
    "test 5000" ignore {
      part2Simulation(testData, 5000) shouldEqual 16733044
    }
  }

  "part 2 comparison" ignore {
    "real 1" in {
      part2CompareClassificationWithSimulation(realData, 1) shouldEqual 4
    }

    "real 130" in {
      part2CompareClassificationWithSimulation(realData, 130) shouldEqual 15497
    }

    "real 131" in {
      part2CompareClassificationWithSimulation(realData, 131) shouldEqual 15724
    }

    "real 133" in {
      part2CompareClassificationWithSimulation(realData, 133) shouldEqual 16194
    }

    "real 257" in {
      part2CompareClassificationWithSimulation(realData, 257) shouldEqual 60136
    }

    "real 259" in {
      part2CompareClassificationWithSimulation(realData, 259) shouldEqual 61056
    }

    "real 260" in {
      part2CompareClassificationWithSimulation(realData, 260) shouldEqual 61553
    }

    "real 261" in {
      part2CompareClassificationWithSimulation(realData, 261) shouldEqual 62004
    }

    "real 262" in {
      part2CompareClassificationWithSimulation(realData, 262) shouldEqual 62457
    }

    "real 263" in {
      part2CompareClassificationWithSimulation(realData, 263) shouldEqual 62930
    }

    "real 264" in {
      part2CompareClassificationWithSimulation(realData, 264) shouldEqual 63390
    }

    "real 265" in {
      part2CompareClassificationWithSimulation(realData, 265) shouldEqual 63904
    }

    "real 350" in {
      part2CompareClassificationWithSimulation(realData, 350) shouldEqual 111444
    }

    "real 351" in {
      part2CompareClassificationWithSimulation(realData, 351) shouldEqual 112092
    }

    "real 352" in {
      part2CompareClassificationWithSimulation(realData, 352) shouldEqual 112697
    }

    "real 353" in {
      part2CompareClassificationWithSimulation(realData, 353) shouldEqual 113381
    }
    ...
    "real 400" in {
      part2CompareClassificationWithSimulation(realData, 400) shouldEqual 145254
    }
  }
